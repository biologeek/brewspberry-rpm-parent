...
export class InputsComponent implements OnInit {
	...
	private currentBrew: Brew = {malts: null}; //{malts: [{id: 1, model: 'Marris Otter'}]};
	private nextMalt: Ingredient = {};
	private nextHop: Ingredient = {};
	private nextYeast: Ingredient = {};
	private nextSpice: Ingredient = {};
	private currentlyModifiedMalt: Ingredient = {};
	private currentlyModifiedHop: Ingredient = {};
	private currentlyModifiedYeast: Ingredient = {};
	private currentlyModifiedSpice: Ingredient = {};
	private formatter;
	private availableMalts: Ingredient[] = [{id: 1, model: 'Marris Otter'}, {id: 2, model: 'Carapils'}, {id: 3, model: 'Café'}];
	private availableHops: Ingredient[] = [{id: 1, model: 'MNelson Sauvin'}, {id: 2, model: 'Saaz'}, {id: 3, model: 'Blabla'}];
	private availableYeasts: Ingredient[] = [{id: 1, model: 'Marris Otter'}, {id: 2, model: 'Carapils'}, {id: 3, model: 'Café'}];
	private availableSpices: Ingredient[] = [{id: 1, model: 'Cannelle'}, {id: 2, model: 'Cumin'}, {id: 3, model: 'Réglisse'}];
	...
	private update(oldModifiedMalt){
