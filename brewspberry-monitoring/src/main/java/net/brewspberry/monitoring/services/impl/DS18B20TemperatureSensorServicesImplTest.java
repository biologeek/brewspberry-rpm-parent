...
public class DS18B20TemperatureSensorServicesImplTest {
	...
	public void shouldRunRegularTemperatureMeasurement() throws Exception {
		...
		when(w1Master.getDevices(0x28)).thenReturn(aListOf2Devices("28-1111111111", "28-1111111112"));
		sut.runRegularTemperatureMeasurement(aListOf1Sensor("28-1111111111"), map);
		
		verify(threadStateServices).witnessThreadStart("28-1111111111");
