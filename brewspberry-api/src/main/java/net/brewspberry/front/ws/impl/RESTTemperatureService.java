...
//	 * 
//	 */
//	public Response initTemperatureForStep(@PathParam("uuid") String uuid, @PathParam("sid") long stepID,
//			@PathParam("maxPts") int maxPointsNumber, @PathParam("delay") float delayToDisplayInSeconds)
//			throws Exception {
//
...
//
//		}
//		return Response.status(200).entity(this.mergeTwoJSONObjects(result, thResult).toString()).build();
//	}
//
//	@GET
...
//	 * @return
//	 */
//	public Response updateTemperatureForStep(@PathParam("uuid") String uuid, @PathParam("sid") long stepID,
//			@PathParam("maxPts") int maxPointsNumber, @PathParam("delay") float delayToDisplayInSeconds,
...
//
//			thResult = this.convertListToJSONObject(
//					this.generateTheoreticalTmesListFromConstant(result, etape.getEtp_palier_type()));
//
//		} else {
//
...
//		}
//
//		return Response.status(200).entity(this.mergeTwoJSONObjects(jsonResult, thResult).toString()).build();
//	}
//
//	/**
