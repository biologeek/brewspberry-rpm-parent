...
public class TemperatureMeasurementDaoImpl
		implements ISpecificTemperatureMeasurementService, IGenericDao<TemperatureMeasurement> {
	...
	@Override
	public List<TemperatureMeasurement> getTemperatureMeasurementByBrassin(Brassin brassin) {

		List<TemperatureMeasurement> result = session.createCriteria(TemperatureMeasurement.class)
	...
	public List<TemperatureMeasurement> getTemperatureMeasurementByEtape(Etape etape) {
		...
		List<TemperatureMeasurement> result = (List<TemperatureMeasurement>) session
				.createCriteria(TemperatureMeasurement.class).add(Restrictions.eq("tmes_etape", etape)).list();
		HibernateUtil.closeSession();
		return result;
	}
	...
	public TemperatureMeasurement getLastTemperatureMeasurementByUUID(String uuid) throws Exception {
		...
		if (uuid != null) {
			...
			if (uuid != "") {
				Criteria cr = session.createCriteria(TemperatureMeasurement.class);
	...
	@Override
	public List<TemperatureMeasurement> getAllLastTemperatureMeasurements(List<String> uuidOrName, Boolean uuid)
			throws Exception {
	...
	@Override
	public List<TemperatureMeasurement> getAllLastTemperatureMeasurementsFromCSV(List<String> uuidOrName, Boolean uuid)
			throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public TemperatureMeasurement getLastTemperatureMeasurementsByNameFromCSV(String uuidOrName, Boolean uuid)
			throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public TemperatureMeasurement save(TemperatureMeasurement arg0) throws DAOException {
	...
	public List<TemperatureMeasurement> getTemperatureMeasurementsAfterID(Etape etape, String uuid, long tmesID,
		...
		if (etape != null) {
			if (tmesID > 0) {
				...
				query = session.createCriteria(TemperatureMeasurement.class).add(Restrictions.gt("tmes_id", tmesID))
						.add(Restrictions.eq("tmes_etape", etape)).add(Restrictions.gt("tmes_date", cal.getTime()))
	...
	@Override
	public List<TemperatureMeasurement> getLastTemperatureByStepAndUUID(Etape stepID, String uuid) {
	...
	public List<TemperatureMeasurement> getLastTemperatureMeasurementByStepUUIDNumberOfPointsAndDelay(Etape etapeID,
		...
		Criteria tmesCriteria = session.createCriteria(TemperatureMeasurement.class);
